...
| **3 — Geld** | Deckelabrechnung mit PDF, E-Mail und QR; Zahlungseingang und Kontoauszug-Import; Erinnerungen. Schichten, Entnahmen, Kassenbuch (mit den App-Bildschirmen). *Stand 22. September 2026: die Abrechnung ist gebaut — Lauf, PDF mit EPC-QR, Versand, CAMT/CSV-Import, Zuordnung, Erinnerung, Storno. Offen: Kasse.* | Der eigentliche Nutzen. Braucht Profile (2) und den unveränderlichen Buchungsstrom (0). |
