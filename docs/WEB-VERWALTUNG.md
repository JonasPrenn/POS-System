...
| **2 — Stammdaten** | Mitglieder und Profile pflegen, Sperren, Produkte und Preise, Lieferanten, Eingangsbelege vervollständigen, Dateien. *Stand 22. September 2026: Mitglieder anlegen und ändern, Aufladung und Korrektur vom Schreibtisch sind gebaut. Offen: Profile, Sperre (braucht ein Feld auf den Tablets), Produkte, Lieferanten, Belege.* | Schreiben in Stammdaten läuft über den vorhandenen Sync-Konfliktweg. |
