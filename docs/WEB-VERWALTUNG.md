...
| **4 — Bücher** | Kontenrahmen, Bereiche, Veranstaltungen, Jahresübersicht mit Vermögensübersicht, Inventur und Lagerwert, Exporte. *Stand 22. September 2026: gebaut ist die Einnahmen-Ausgaben-Rechnung je Rechnungsjahr mit Vorjahr, nach Konto und Bereich, dazu die Vermögensübersicht zum Stichtag (Bankstand trägt der Kassier ein) und zwei CSV-Exporte (Rechnung, Journal). Offen: Veranstaltungen als Kostenstelle, Inventur mit Schwundbericht, Bestellvorschlag, das BMD-Format, die Prüfermappe als PDF.* | Baut auf allem auf; erst hier zahlt sich die Disziplin der anfügenden Tabellen aus. |
