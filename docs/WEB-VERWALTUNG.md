...
- **Import und Export** als CSV (im Web gebaut: Import mit Vorschau, Export mit den
  Profilfeldern; die Datei des Tablets geht in beide Richtungen), zusätzlich der Datenschutz-Export für ein
...
| **2 — Stammdaten** | Mitglieder und Profile pflegen, Sperren, Produkte und Preise, Lieferanten, Eingangsbelege vervollständigen, Dateien. *Stand 22. September 2026: gebaut sind Mitglieder anlegen und ändern (mit Couleurname), Aufladung und Korrektur vom Schreibtisch, Lieferanten, Eingangsbelege mit Datei, Fälligkeit und Zahlung, Zuordnung zu Lagerartikeln und Konten. Rechnungen kommen per E-Mail ins System: Das Postfach wird abgerufen, freigegebene Absender werden gleich ein Beleg mit den gemerkten Positionen, unbekannte warten im Posteingang. Ein PDF mit Textebene wird gelesen: Lieferant, Nummer, Datum, Betrag und Positionen als Vorschlag, je Position der passende Lagerartikel — gemerkt je Lieferant, sobald der Kassier es einmal bestätigt hat. Dazu das Sortiment: Produkte, Preise, Varianten, Rezepturen, aus dem Sortiment nehmen, und die Kategorien mit Limits. Die Sperre mit Grund (`members.blocked_reason`, Schema 14): Die Theke zeigt sie beim Mitglied und schreibt nicht mehr an, Bar und Karte gehen. Profile sind seit 3a da. Dazu CSV-Import mit Vorschau und CSV-Export, und das Löschen bei ausgeglichenem Deckel. Offen: die Datenschutz-Auskunft je Mitglied.* | Schreiben in Stammdaten läuft über den vorhandenen Sync-Konfliktweg. |
| **3 — Geld** | Deckelabrechnung mit PDF, E-Mail und QR; Zahlungseingang und Kontoauszug-Import; Erinnerungen. Schichten, Entnahmen, Kassenbuch (mit den App-Bildschirmen). *Stand 22. September 2026: gebaut. Abrechnung — Lauf, PDF mit EPC-QR, Versand, CAMT/CSV-Import, Zuordnung, Erinnerung, Storno; eine Aufladung an der Theke nach dem Stichtag steht an der Abrechnung und auf der Übersicht, ein Klick schließt sie damit ohne zweite Buchung. Kasse — Bardienst beginnen (Mitglied aus der Liste, mit Barkasse und Wechselgeld oder ohne, dann kein Bargeld an der Theke), Entnahme und Einlage, Schließen mit Zählung und Differenzvermerk am Tablet (`CashSection`, Schema 13 und 15); im Web Tagesbericht je Gerät, laufende Schichten, Kassenbuch mit fortgeführtem Bestand und CSV, Bankbuch. Offen: das Kassenbuch als PDF, der Storno einer Bewegung per Gegenbuchung (heute: eine zweite Bewegung mit Grund).* | Der eigentliche Nutzen. Braucht Profile (2) und den unveränderlichen Buchungsstrom (0). |
| **4 — Bücher** | Kontenrahmen, Bereiche, Veranstaltungen, Jahresübersicht mit Vermögensübersicht, Inventur und Lagerwert, Exporte. *Stand 22. September 2026: gebaut ist die Einnahmen-Ausgaben-Rechnung je Rechnungsjahr mit Vorjahr, nach Konto und Bereich, dazu die Vermögensübersicht zum Stichtag (Bankstand trägt der Kassier ein), zwei CSV-Exporte (Rechnung, Journal) und die Prüfermappe als PDF (Rechnung, Vermögen, Kassabuch, Belegliste, Abrechnungen). Pfand und Leergut je Gebindeart unter Lager, aus der Gebindetabelle der Rechnung oder von Hand, mit Pfandwert in der Vermögensübersicht. Der Bestellvorschlag steht unter Lager: alles unter Mindestbestand, gruppiert nach dem Lieferanten der letzten Lieferung, auf das Doppelte des Mindestbestands, Fässer in ganzen Gebinden. Offen: Veranstaltungen als Kostenstelle, Inventur mit Schwundbericht, das BMD-Format, die Belegdateien in der Mappe.* | Baut auf allem auf; erst hier zahlt sich die Disziplin der anfügenden Tabellen aus. |
